...
export default function CartItemCarousel({ items }) {
    ...
    return (
        <div className='position-relative'>
            <button
                className="carousel-control-prev position-absolute translate-middle-y start-0"
                style={{ top: "170px" }}
                onClick={handlePrev}
            >
            ...
            <button
                className="carousel-control-next position-absolute translate-middle-y end-0"
                style={{ top: "170px" }}
                onClick={handleNext}
            >
            ...
            <div className='d-flex overflow-hidden'>
                <div className='d-flex' style={{ width: `${itemsPerPage * 100}%` }}>
